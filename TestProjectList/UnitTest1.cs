...
namespace TestProjectList
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void Constructor_NullCollection()
        {
            // Arrange
            BankCard[] array = null;
            ...
            {
                // Act
                MyList<BankCard> myList = new MyList<BankCard>(array);
            ...
            {
                // Assert
                Assert.AreEqual("Пустая коллекция: нуль", ex.Message);
            }
        }
        ...
        [TestMethod]
        public void Constructor_EmptyCollection()
        {
            // Arrange
            BankCard[] array = new BankCard[0];
            ...
            {
                // Assert
                Assert.AreEqual("Пустая коллекция", ex.Message);
            }
        }
